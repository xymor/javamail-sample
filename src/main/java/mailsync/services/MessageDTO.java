...
public class MessageDTO {
	...
	static public Message[] difference(Message[] listA, Message[] listB) {
		SetView<MessageDTO> difference = Sets.difference(buildDtos(listA), buildDtos(listB));
	...
	private String findContent(Message m) throws IOException, MessagingException{
